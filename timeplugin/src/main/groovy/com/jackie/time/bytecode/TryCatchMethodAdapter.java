 ...
 * @date 2020/6/17
 */
public class TryCatchMethodAdapter extends AdviceAdapter implements Opcodes {
     ...
     */
    protected TryCatchMethodAdapter(MethodVisitor methodVisitor, int access, String name, String descriptor) {
...
//        this.methodVisitor = methodVisitor;
    ...
    protected void onMethodEnter() {
        ...
        if (!methodName.contains("testHasReturnInt") || !methodName.contains("MainActivity")) {
            return;
        }
